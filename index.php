...
<html> 
    <head>
        ...
        <title>Kys News</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link type="image/x-icon" href="circle-cropped.png" rel="shortcut icon" />
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <!--Vnexpress-->
        <ul class="list-group">
        <li class="list-group-item active" ><a style="color : #fff;" href="https://vnexpress.net/" target="_blank" >VnExpress</a></li>
        <?php
        $html_vnex = file_get_html("https://vnexpress.net/");
        $big_title = $html_vnex->find('div[class=thumb-art] img' , 0)->alt;
        ...
        $list = $html_vnex->find('ul[class=list-sub-feature] li p[class=description] a');
        foreach ($list as $menu) {
                 $title_vnex = $menu->title;
                 $link_vnex =  $menu->href;
                  echo "<li class='list-group-item'  style='font-size:15px;'> <a href='$link_vnex' onclick='doalert(this); return false;'>● ".$title_vnex."</a></li>";
        }
        $list1 = $html_vnex->find('section[class=section section_container] article[class=item-news item-news-common ] div[class=thumb-art] a');
...
?>
       ...
       <!--Dantri-->
        <ul class="list-group">
        <li class="list-group-item active"><a style="color : #fff;" href="http://dantri.com.vn/" target="_blank" > Dân Trí</a></li>
        <?php
       ...
       <!--Vietnamnet-->
        <ul class="list-group">
        <li class="list-group-item active"><a style="color : #fff;" href="http://vietnamnet.vn/" target="_blank" >VietNamNet</a></li>
        <?php
       ...
       <!--Tuổi Trẻ-->
       <ul class="list-group">
        <li class="list-group-item active"><a style="color : #fff;" href="https://tuoitre.vn/" target="_blank" >Tuổi Trẻ</a></li>
        <?php
       ...
       <!--Thanh Niên-->
       <ul class="list-group">
        <li class="list-group-item active"><a style="color : #fff;" href="https://thanhnien.vn/" target="_blank" >Thanh Niên</a></li>
       ...
       <!--Saostar-->
       <ul class="list-group">
        <li class="list-group-item active"><a style="color : #fff;" href="https://saostar.vn/" target="_blank" >Saostar</a></li>
            ...
            <div class="accordion" id="accordionExample">
                 <div class="card" >
                    ...
                    <div class="card-body">
                        ...
                        <input  style="height: 40px; " placeholder="" id="validationDefault01"  name="url"  autocomplete="off" type="text" class="form-control"  >
                        <div class="input-group-append">
                            <button name="submit" class="btn btn-outline-secondary" type="submit" id="button-addon2">KYS NEWS</button>
                        </div>
                        </div>
                        </form><br>
                        <?php
                        error_reporting(0);
                                ...
                                switch ($host) {
                                    case 'vnexpress.net':
                                        ...
                                        $topic = $html->find("ul[class=breadcrumb] li a",0)." > ".$html->find("ul[class=breadcrumb] li a",1)->title;
                                    ...
                                    case 'dantri.com.vn':
                                        ...
                                        $topic = $html->find("a[class=breadcrumbitem1]",1)->innertext;
                                        $des = $html->find("meta[name=twitter:description]",0)->content;
                                    ...
                                    case 'vietnamnet.vn':
                                        ...
                                        $topic = $html->find("div[class=top-cate-head-title]",0)->innertext;
                                    ...
                                    case 'tuoitre.vn':
                                        ...
                                        $topic = $html->find("div[class=bread-crumbs fl] li[class=fl] a",0)->title;
                                        $des = $html->find("meta[name=description]",0)->content;
